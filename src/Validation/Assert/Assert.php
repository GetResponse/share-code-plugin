...
{
    /** @var string */
    protected static $lazyAssertionExceptionClass = 'GrShareCode\Validation\Assert\LazyAssertionException';

    /** @var string */
    protected static $assertionClass = 'GrShareCode\Validation\Assert\Assertion';
